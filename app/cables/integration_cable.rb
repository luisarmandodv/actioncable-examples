class IntegrationCable < BaseCable
  def login_and_fetch_readers
    ...
    if ENV['EPIC_INTEGRATION_DEV_MODE'] == 'LOGIN_FAIL' # LOGIN_FAIL_LOCKED, LOGIN_FAIL_RESPONSE_BODY_NULL, READER_LIST_FAIL_EPIC_BROKE_API
      stream_login_and_fetch_readers_fail_login_json({
    ...
    #*DTA TODO STREAM SUCCESSFUL LIST
    stream_login_success_json({
...
#*DTA TODO REDUCE AMOUNT OF DATA RETURNED
    if ENV['EPIC_INTEGRATION_DEV_MODE'] == 'SUCCESS_NO_EARNED_BADGES'
      stream_sync_readers_success_json({
